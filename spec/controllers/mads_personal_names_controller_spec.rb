...
describe MadsPersonalNamesController do
  describe "A login user" do
	  ...
	  describe "Show" do
	    before do
	      @obj = MadsPersonalName.create(name: "Personal Name Test ", sameAs:  "http://lccn.loc.gov/n90694888")
	      #puts @obj.id
	    end
	  ...
	  describe "Edit" do
	    before do
	      @obj = MadsPersonalName.create(name: "Personal Name", sameAs:  "http://lccn.loc.gov/n90694888")
	    end    
	    it "should be successful" do 
	      get :edit, id: @obj.id
	      response.should be_successful 
	  ...
	  describe "Create" do
	    it "should be successful" do
	      expect { 
	        post :create, :mads_personal_name => {name: ["Test Name"] , sameAs:  ["http://lccn.loc.gov/n90694888"]}
	  ...
	  describe "Update" do
	    ...
	    it "should be successful" do
	      put :update, :id => @obj.id, :mads_personal_name => {name: ["Test Title2"], sameAs:  ["http://lccn.loc.gov/n90694888"]}
	      response.should redirect_to assigns[:mads_personal_name]
