  ...
  describe "when signed in" do
    ...
    describe "#create" do
      ...
      it "should set the attributes" do
        post :create, dams_function: {"name"=>"TestLabel", "externalAuthority"=>"http://test.com", "functionElement_attributes"=>{"0"=>{"elementValue"=>"Test Function"}}, "scheme_attributes"=>[{"id"=>"http://library.ucsd.edu/ark:/20775/#{scheme.pid}"}]}
    ...
    describe "#update" do
      ...
      it "should set the attributes" do
        put :update, id: function, dams_function: {"name"=>"TestLabel", "externalAuthority"=>"http://test.com", "functionElement_attributes"=>{"0"=>{"elementValue"=>"Test Function"}}, "scheme_attributes"=>[{"id"=>"http://library.ucsd.edu/ark:/20775/#{scheme2.pid}"}]}
