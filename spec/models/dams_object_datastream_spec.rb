  ...
  describe "a complex data model" do
    ...
    describe "an instance with content" do
      ...
      it "should have inline subjects" do
        subVals = ["Academic dissertations","Black Panther Party--History","African Americans--Relations with Mexican Americans--History--20th Century"]
        subVals.should include subject.complexSubject[0].name.first
        subVals.should include subject.complexSubject[1].name.first
      end
