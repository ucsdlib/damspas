...
describe DamsSourceCaptureDatastream do
  ...
  describe "a source capture model" do
    ...
    describe "instance populated in-memory" do
      ...
      subject { DamsSourceCaptureDatastream.new(double('inner object', :pid=>'bbXXXXXX24', :new? => true), 'damsMetadata') }
    ...
    describe "an instance loaded from fixture xml" do
      ...
      subject do
        subject = DamsSourceCaptureDatastream.new(double('inner object', :pid=>'bb49494949', :new? =>true), 'damsMetadata')
