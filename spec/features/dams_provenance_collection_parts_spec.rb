...
feature 'Visitor wants to create/edit a provenance collection part' do
	scenario 'is on dams provenance collection part page' do
		...
		fill_in "dams_provenance_collection_part_note_attributes_0_type", :with => "TestType2"
		fill_in "dams_provenance_collection_part_note_attributes_0_displayLabel", :with => "TestNoteDisplayLabel2"
		fill_in "dams_provenance_collection_part_scopeContentNote_attributes_0_value", :with => "TestScopeContentNote2"
		fill_in "dams_provenance_collection_part_scopeContentNote_attributes_0_type", :with => "TestScopeContentNoteType2"
...
feature 'Visitor wants to cancel unsaved edits' do
	...
	scenario 'is on Edit Provenance Collection part page' do
		...
		fill_in "dams_provenance_collection_part_note_attributes_0_type", :with => "CancelNoteType"
		fill_in "dams_provenance_collection_part_note_attributes_0_displayLabel", :with => "CancelNoteDisplaylabel"
		fill_in "dams_provenance_collection_part_scopeContentNote_attributes_0_value", :with => "CancelScopeContentNote"
		fill_in "dams_provenance_collection_part_scopeContentNote_attributes_0_type", :with => "CancelScopeContentNoteType"
		click_on "Cancel"
		visit Path.path
