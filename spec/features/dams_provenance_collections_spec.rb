...
feature 'Visitor wants to create/edit a provenance collection' do
	scenario 'is on dams provenance collection page' do
		...
		fill_in "dams_provenance_collection_title_attributes_0_mainTitleElement_attributes_0_elementValue", :with => "TestTitle"
		fill_in "dams_provenance_collection_title_attributes_0_subTitleElement_attributes_0_elementValue", :with => "TestSubTitle"
		fill_in "dams_provenance_collection_title_attributes_0_partNameElement_attributes_0_elementValue", :with => "TestPartName"
		fill_in "dams_provenance_collection_title_attributes_0_partNumberElement_attributes_0_elementValue", :with => "TestPartNumber"
		fill_in "dams_provenance_collection_title_attributes_0_nonSortElement_attributes_0_elementValue", :with => "TestNonSort"
		fill_in "dams_provenance_collection_date_attributes_0_value", :with => "TestDate"
		fill_in "dams_provenance_collection_date_attributes_0_beginDate", :with => "2001-01-01"
		...
		fill_in "dams_provenance_collection_scopeContentNote_attributes_0_value", :with => "TestScopeContentNote"
		fill_in "dams_provenance_collection_scopeContentNote_attributes_0_type", :with => "TestScopeContentNoteType"
		fill_in "dams_provenance_collection_scopeContentNote_attributes_0_displayLabel", :with => "TestScopeContentNoteDisplayLabel"
		page.select('CorporateName', match: :first)
		fill_in "dams_provenance_collection_relatedResource_attributes_0_type", :with => "TestRelatedResourceType"
		fill_in "dams_provenance_collection_relatedResource_attributes_0_uri", :with => "http://www.google.com"
		fill_in "dams_provenance_collection_relatedResource_attributes_0_description", :with => "TestRelatedResourceDescription"
		click_on "Save"
		...
		fill_in "dams_provenance_collection_date_attributes_0_value", :with => "TestDate2"
		fill_in "dams_provenance_collection_date_attributes_0_beginDate", :with => "2001-01-01"
		fill_in "dams_provenance_collection_date_attributes_0_endDate", :with => "2001-01-31"
...
feature 'Visitor wants to cancel unsaved edits' do
	...
	scenario 'is on Edit Provenance Collection page' do
        ...
        fill_in "dams_provenance_collection_date_attributes_0_value", :with => "CancelDate"
		fill_in "dams_provenance_collection_date_attributes_0_beginDate", :with => "CancelBeginDate"
