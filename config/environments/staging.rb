Hydra::Application.configure do
  ...
  config.secure_token_audio_baseurl = 'lib-streaming.ucsd.edu:1936/dams4-test-securetoken/_definst_/mp3:'
  config.secure_token_video_baseurl = 'lib-streaming.ucsd.edu:1936/dams4-test-securetoken/_definst_/mp4:'
