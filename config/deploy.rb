...
set :linked_files, %w{config/database.yml config/fedora.yml config/solr.yml config/share_notify.yml config/initializers/secret_token.rb config/initializers/devise.rb config/.coveralls.yml}
