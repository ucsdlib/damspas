class MadsTitle < ActiveFedora::Rdf::Resource
...
#  }
  ...
  map_predicates do |map|
    ...
    map.elem_list(:in => MADS, :to => 'elementList', :class_name=>'MadsTitle::MadsTitleElementList')
  end
  ...
  class MadsTitleElementList < ActiveFedora::Rdf::List
    map_predicates do |map|
      map.nonSortElement(:in=> MADS, :to =>"NonSortElement", :class_name => "MadsTitle::MadsNonSortElement")
      map.mainTitleElement(:in=> MADS, :to =>"MainTitleElement", :class_name => "MadsTitle::MadsMainTitleElement")
      map.partNameElement(:in=> MADS, :to =>"PartNameElement", :class_name => "MadsTitle::MadsPartNameElement")
      map.partNumberElement(:in=> MADS, :to =>"PartNumberElement", :class_name => "MadsTitle::MadsPartNumberElement")
      map.subTitleElement(:in=> MADS, :to =>"SubTitleElement", :class_name => "MadsTitle::MadsSubTitleElement")
    end
    accepts_nested_attributes_for :nonSortElement, :mainTitleElement, :partNameElement, :partNumberElement, :subTitleElement
  end
  class MadsNonSortElement < ActiveFedora::Rdf::Resource
    include Dams::MadsElement
    rdf_type MADS.NonSortElement
  end
  class MadsMainTitleElement < ActiveFedora::Rdf::Resource
    include Dams::MadsElement
    rdf_type MADS.MainTitleElement
  end
  class MadsPartNameElement < ActiveFedora::Rdf::Resource
    include Dams::MadsElement
    rdf_type MADS.PartNameElement
  end
  class MadsPartNumberElement < ActiveFedora::Rdf::Resource
    include Dams::MadsElement
    rdf_type MADS.PartNumberElement
  end
  class MadsSubTitleElement < ActiveFedora::Rdf::Resource
    include Dams::MadsElement
