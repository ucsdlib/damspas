class DamsCustodialResponsibilityNoteDatastream < ActiveFedora::RdfxmlRDFDatastream
  ...
  def serialize
    graph.insert([rdf_subject, RDF.type, DAMS.CustodialResponsibilityNote]) if new?
    super
  end
