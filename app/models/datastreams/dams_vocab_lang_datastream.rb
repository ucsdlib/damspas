class DamsVocabLangDatastream < ActiveFedora::NokogiriDatastream
set_terminology do |t|
  ...
  def self.xml_template
    Nokogiri::XML::Document.parse(File.new(File.join(File.dirname(__FILE__),'..', '..', '..', 'lib', "damsVocabLang.xml")))
  end
