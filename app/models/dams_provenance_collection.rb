class DamsProvenanceCollection < ActiveFedora::Base
  ...
  delegate_to "damsMetadata", [:scopeContentNoteType, :scopeContentNoteDisplayLabel, :scopeContentNoteValue, :noteValue, :noteType, :noteDisplayLabel, :relationshipName, :languageValue, :title, :titleValue, :subtitle, :titlePartName, :titlePartNumber,:typeOfResource, :date, :dateValue, :beginDate, :endDate, :subject, :topic, :component, :file, :relatedResource, :language, :unit, :note, :sourceCapture, :subjectValue, :subjectURI, :unitURI, :subjectType, :subjectTypeValue ]
